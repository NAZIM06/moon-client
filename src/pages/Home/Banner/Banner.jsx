    ...
    <div className="carousel-container">
      ...
      >
        ...
        <div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center md:w-3/4 lg:w-1/2">
            <Fade><p className="text-blue-900 text-2xl md:text-6xl font-bold mb-3">Modern Ring</p>
              <p className="md:text-xl text-black font-bold hidden sm:block">Stock <span className='font-bold text-blue-900'>Limit</span> In</p></Fade>
            <button className="btn bg-blue-900 text-white hover:text-black font-medium mx-auto btn-sm md:btn-md lg:btn-lg mt-3 md:mt-5">Buy Now</button>
          </div>
        ...
        <div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center md:w-3/4 lg:w-1/2">
            <Fade><p className="text-blue-900 text-2xl md:text-6xl font-bold mb-3">New Arrivals</p>
              <p className="md:text-xl text-black font-bold hidden sm:block">Get <span className='font-bold text-blue-900'>25%</span> Off</p></Fade>
            <button className="btn bg-blue-900 text-white hover:text-black font-medium mx-auto btn-sm md:btn-md lg:btn-lg mt-3 md:mt-5">Buy Now</button>
          </div>
